...
interface CertificateDetailsType {
  companyName?: string;
  productName?: string;
  eventName?: string;
  eventDate?: string;
...
interface CertificateType {
  ...
  purpose: string;
  details: CertificateDetailsType;
      ...
      <div className="certificate">
        ...
        <div className="certificate-body">
          <div className="certificate-statement">
            ...
            {certificate.purpose === 'carbon_neutral_event' && certificate.details.eventName && certificate.details.eventDate && (
