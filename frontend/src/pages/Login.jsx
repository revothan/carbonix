            ...
            <Tabs defaultValue="email" className="w-full" onValueChange={setActiveTab}>
              ...
              <TabsContent value="social" className="pt-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button 
                    className="w-full bg-[#3b5998] hover:bg-[#3b5998]/90" 
                    onClick={() => handleSocialLogin('facebook')}
                    disabled={loading}
                  >
                    <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.03954 23V12.5H6V8.5H9.03954V5.5C9.03954 2.5 10.7 0 14.9831 0C16.5367 0 17.8005 0.15 17.8005 0.15L17.6855 3.87C17.6855 3.87 16.4989 3.857 15.2023 3.857C13.7978 3.857 13.5978 4.5 13.5978 5.62V8.5H17.8L17.5666 12.5H13.5978V23H9.03954Z"/>
                    </svg>
